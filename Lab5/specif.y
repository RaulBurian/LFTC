...
expression : term | expression operation expression | LEFT_ROUND_PARENTHESIS expression operation expression RIGHT_ROUND_PARENTHESIS ;
operation : PLUS | MINUS | MULTIPLY | DIVISION | MOD ;
term : IDENTIFIER | CONSTANT ;
out_statement : COUT EXTRACT term SEMI_COLON ;
in_statement : CIN INSERT IDENTIFIER SEMI_COLON ;
